...
inpConfidence=0.5 #minimum probability to filter weak detections
model = load_model("model/mask_detector2.model")
...
while True:
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > inpConfidence:
            ...
            cv2.putText(image, label, (startX, startY - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.65, color, 1)
